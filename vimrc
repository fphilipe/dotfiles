...
au FileType coffee,slim,yaml setlocal foldmethod=expr
...
" }}}
" Searches                                                                   {{{
let SqlCapitalize = '\<\(select\|update\|set\|from\|where\|and\|or\|on\|join\|not\|null\|is\|using\|case\|when\|else\|if\|elsif\|end\|as\|order\|by\|asc\|desc\|limit\|with\|over\|partition\|group\|like\|left\|right\|outer\|inner\|full\)\>\C'
" }}}
